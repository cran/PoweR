...
// Computation of the value of the test statistic
      ...
      double *xtmp;
      xtmp = new double[n];
      double statTLmom, l1, l2, l3, l4, tau3, tau4, b1=0.0, b2=0.0, b3=0.0, b4=0.0;
      ...
      b1 = b1 + xtmp[0] + xtmp[1] + xtmp[2];
      b2 = b2 + 1.0*xtmp[1] + 2.0*xtmp[2];
      b3 = b3 + 2.0*xtmp[2];
      
	  for (i=4;i<=n;i++) {
		b1 = b1 + xtmp[i-1];
		b2 = b2 + ((double)(i-1))*xtmp[i-1];
		b3 = b3 + (double)((i-1)*(i-2))*xtmp[i-1];
		b4 = b4 + (double)((i-1)*(i-2)*(i-3))*xtmp[i-1];
      }
