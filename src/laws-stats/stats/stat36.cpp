// Title: Statistique de test P_2 dans l'article 2 avec Alain et Alexandre ...
// Ref. (book or article): 
...
// Computation of the value of the test statistic
    ...
    statvalue = sqrt((double)n)*((deltachap-(2.0-log(2.0)-gamma)*R_pow(1-2.0/(double)n,0.9)*(1.0+0.43/(double)n))/sqrt(2.0*(3.0*R_pow(M_PI,2.0)/4.0-7.0)*R_pow(1.0-2.0/(double)n,0.9)*(1.0-2.67/(double)n)));
