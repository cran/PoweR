checklaw <- function(law.index,sample.size=50000,law.pars=NULL,density=NULL,trunc=c(-Inf,Inf)) {
  ...
  x <- gensample(law.index=law.index,n=sample.size,law.pars=out$law.pars)
